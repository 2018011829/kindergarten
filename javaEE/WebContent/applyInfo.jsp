...
<body>
	<div id="box">
			...
			<div id="menu">
				<ul class="menu">
					...
					<ul class="enroll_menu" id="click_enroll_menu" style="display: block">
						<li onclick="showMenu_info2()" id="enroll_info"  style="background: #009688"><a
		...
		<div class="box1" style="height:150px">
			<form action="ExportFileToExcel" method="post">
				 <input type="submit" value="导出报名表"
					id="submitSearch">
			</form>
		</div>
		<div class="box2">
				...
				<div class="box4">
					<div class="box5">
						总共有${page.totalPageNum }页，总共有${page.totalCount }个数据； <a
							href="GetApplyInfoServlet?page=1" style="color: black">首页</a> <a
							href="GetApplyInfoServlet?page=${page.prePageNum }"
							style="color: black">上一页</a> <a
							href="GetApplyInfoServlet?page=${page.nextPageNum }"
							style="color: black">下一页</a> <a
							href="GetApplyInfoServlet?page=${page.totalPageNum }"
