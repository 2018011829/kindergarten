...
/**
 * Servlet implementation class UpdateApplyinfoServlet2
 */
@WebServlet("/UpdateApplyinfoServlet2")
public class UpdateApplyinfoServlet2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateApplyinfoServlet2() {
        super();
