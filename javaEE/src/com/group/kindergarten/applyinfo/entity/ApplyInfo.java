package com.group.kindergarten.applyinfo.entity;
...
public class ApplyInfo {
	...
	public ApplyInfo(int id, String userNumber, String babyName, String babyBirthday, String babySex,
	...
	public String toString() {
		return "ApplyInfo [id=" + id + ", userNumber=" + userNumber + ", babyName=" + babyName + ", babyBirthday="
				+ babyBirthday + ", babySex=" + babySex + ", babyIDnumber=" + babyIDnumber + ", babyAddoAllergies="
				+ babyAddoAllergies + ", parentName1=" + parentName1 + ", relation1=" + relation1 + ", parentIDnumber1="
				+ parentIDnumber1 + ", phoneNumber1=" + phoneNumber1 + ", workSpace1=" + workSpace1 + ", homeAddress1="
				+ homeAddress1 + ", parentName2=" + parentName2 + ", relation2=" + relation2 + ", parentIDnumber2="
				+ parentIDnumber2 + ", phoneNumber2=" + phoneNumber2 + ", workSpace2=" + workSpace2 + ", homeAddress2="
				+ homeAddress2 + "]";
	}
