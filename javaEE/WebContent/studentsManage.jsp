    ...
    <div id="box">
            ...
            <div id="menu">
                <ul class="menu">
					...
					<ul class="teacher_menu" id="click_teacher_menu"
                        ...
                        <li onclick="showMenu_info4()" id="teacher_add"><a href="deletedTeacherManage">查看离职教师信息</a></li>
					</ul>
        ...
        <div class="box1" style="height:150px;">
            <form action="SearchStudentsServlet" method="post">
                <input type="text" name="studentsName" placeholder="请输入孩子的姓氏或名字"
            ...
            <div class="box3">
                ...
                <div class="box4">
                    <div class="box5">
                        ...
                        <a href="StudentsManageServlet?page=1" style="color: black">首页</a>
                        <a href="StudentsManageServlet?page=${page.prePageNum }"
                            style="color: black">上一页</a>
                        <a href="StudentsManageServlet?page=${page.nextPageNum }"
                            style="color: black">下一页</a>
                        <a href="StudentsManageServlet?page=${page.totalPageNum }"
