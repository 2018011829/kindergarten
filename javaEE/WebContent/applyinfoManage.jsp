...
<body>
			...
			<div id="menu">
				<ul class="menu">
					...
					<ul class="enroll_menu" id="click_enroll_menu"
						...
						<li onclick="showMenu_manage2()" id="enroll_info_manage"
	...
	<c:forEach var="applyInfo" items="${page.list }">
		<tr align="center" height="40px">
			...
			<td ><a href="updateApplyinfo.jsp?page=${page.currentPageNum }&id=${applyInfo.getId() }&babyName=${applyInfo.getBabyName()}&babyBirthday=${applyInfo.getBabyBirthday() }&babySex=${applyInfo.getBabySex()}&babyIDnumber=${applyInfo.getBabyIDnumber()}&babyAddoAllergies=${applyInfo.getBabyAddoAllergies()}&
			...
			<td ><a href="DeleteApplyinfoServlet?id=${applyInfo.getId() }&page=${page.currentPageNum }&size=${page.pageSize }&count=${page.totalCount }" style="color:blue">删除</a></td>
		</tr>
	</c:forEach>
	</table>
	</div>
	...
	<a href="GetApplyInfoServlet2?page=1" style="color:blue">首页</a>
	<a href="GetApplyInfoServlet2?page=${page.prePageNum }" style="color:blue">上一页</a>
	<a href="GetApplyInfoServlet2?page=${page.nextPageNum }" style="color:blue">下一页</a>
	<a href="GetApplyInfoServlet2?page=${page.totalPageNum }" style="color:blue">末页</a>
	</div>
</body>
</html>