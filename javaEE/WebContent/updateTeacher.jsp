        ...
        <div class="editBox1"style="width:100%;height:800px;text-align:center;">
            ...
            <div class="updateBox2">
               ...
               <form action="updateTeacherManage" method="post" enctype="multipart/form-data" style="margin-top:30px">
                    ...
                    <div style="width:500px;height:50px;text-align:center;text-indent:8px;">
                    ...
                    <div class="updateBox3">
                        ...
                        <input type="text" name="teacherPhone" value="${teacher.phone }" class="updateInput"/>
                    </div><br/>
                    <div class="updateBox3">
                        <div class="updateBox4"">座右铭：</div>
                        <input type="text" name="teacherMotto" value="${teacher.motto }" class="updateInput"/>
                    </div><br/>
