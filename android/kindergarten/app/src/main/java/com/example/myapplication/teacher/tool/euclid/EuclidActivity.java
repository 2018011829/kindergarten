...
>>>>>>> ef0d9500f84ec444c46dad0845bb250967d35aab
    ...
    private void initList() {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                showProfileDetails((Teacher) parent.getItemAtPosition(position), view);
            }
        });
    }
     ...
     */
    private void showProfileDetails(Teacher item, final View view) {
     ...
     * @param view - clicked view.
     */
    private void addOverlayListItem(Teacher item, View view) {
        if (mOverlayListItemView == null) {
            mOverlayListItemView = getLayoutInflater().inflate(R.layout.euclid_overlay_list_item, mWrapper, false);
        } else {
        ...
        ((TextView) mOverlayListItemView.findViewById(R.id.text_view_description)).setText(item.getPosition());
     ...
     * @param item - data from adapter, that will be set into overlay view.
     */
    private void setProfileDetailsInfo(Teacher item) {
        mTextViewProfileName.setText(item.getName());
        mTextViewProfileDescription.setText(item.getMotto());
        mTextViewProfilePhone.setText(item.getPhone());
        mTextViewProfilePosition.setText(item.getPosition());
    }
...
//                    mButtonProfile.setVisibility(View.INVISIBLE);
     ...
     *
     * @return - adapter with data. Check
     */
