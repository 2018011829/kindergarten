				...
				<fieldset>
					<div class="editBox1"
						...
						<div class="updateBox1">
							<p id="text">原图片</p>
							<img alt="" src="imgs/schoolInfoPicture/${picture }" id="oldImg">
						</div>
						<div class="updateBox2" style="float:left">
							<form action="UploadPicture" method="post"
								enctype="multipart/form-data" style="margin-top: 30px">
								<input type="hidden" name="pictureLast" value="${picture }" />
								...
								<div
									...
									<div style="margin: 0 auto;">
										...
										<div class="updateBox5">
											<input type="file" name="picture" id="updateImgFile" />
										</div>
									</div>
								</div>
								<br />
