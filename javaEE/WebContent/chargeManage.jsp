			...
			<div id="menu">
				<ul class="menu">
					...
					<ul class="account_menu" id="click_account_menu"
						...
						<li onclick="showMenu_info5()" id="account_info"  style="background: #009688"><a
					...
					<div class="box4">
						<div class="box5">
							总共有${page.totalPageNum }页，总共有${page.totalCount }个数据； <a
								href="ChargeManagerServlet?page=1&userName=${userName }"
								style="color: black">首页</a> <a
								href="ChargeManagerServlet?page=${page.prePageNum }&userName=${userName }"
								style="color: black">上一页</a> <a
								href="ChargeManagerServlet?page=${page.nextPageNum }&userName=${userName }"
								style="color: black">下一页</a> <a
								href="ChargeManagerServlet?page=${page.totalPageNum }&userName=${userName }"
