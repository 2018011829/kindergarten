...
<body>
    ...
    <div id="box">
        ...
        <div class="box1" style="height:150px;">
            <form action="SearchStudentsServlet" method="post">
                <input type="text" name="studentsName" value="${studentsName }"
            ...
            <div class="box3">
                ...
                <div class="box4">
                    <div class="box5">
                        ...
                        <a href="SearchStudentsServlet?page=1&studentsName=${studentsName}" style="color: black">首页</a>
                        <a href="SearchStudentsServlet?page=${page.prePageNum }&studentsName=${studentsName}"
                            style="color: black">上一页</a>
                        <a href="SearchStudentsServlet?page=${page.nextPageNum }&studentsName=${studentsName}"
                            style="color: black">下一页</a>
                        <a href="SearchStudentsServlet?page=${page.totalPageNum }&studentsName=${studentsName}"
